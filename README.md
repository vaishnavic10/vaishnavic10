...
<!--
**vaishnavic10/vaishnavic10** is a ✨ _special_ ✨ repository because its `README.md` (this file) appears on your GitHub profile.

Here are some ideas to get you started:<h1 align="center">Hi 👋, I'm Vaishnavi Chopade!</h1>
...
```json
{
  ...
  "Tools": ["Git", "GitHub", "VS Code", "Postman", "Jupyter Notebook", "Ecllipse"]
